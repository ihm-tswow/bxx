...
// modified by bxx:
// copied and modified from https://github.com/boostorg/stacktrace/pull/124
// thanks to https://github.com/akarpovskii for pdb unload fix!!!
...
class debugging_symbols: boost::noncopyable {
    static void try_init_com(com_holder< ::IDebugClient>& iclient, com_holder< ::IDebugSymbols>& idebug,
        ...
        // QueryInterface sets the output parameter to NULL in case of error.
